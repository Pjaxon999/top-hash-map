...
export default class LinkedList {
    ...
    // access the key value pair of a key if it is found
    find(key) {
        let currentNode = this.head;
        while (currentNode !== null) {
            if (currentNode.key === key) {
                return currentNode;  // Return the node itself
            }
            currentNode = currentNode.nextNode;
        }
        return null;
    ...
    // returns all unique values in the list
    getValues() {
        let output = [];
        let currentNode = this.head;
        while (currentNode !== null) {
    ...
    // returns all key, value pairs in the list
    getPairs() {
        let output = [];
        let currentNode = this.head;
        while(currentNode !== null) {
            output.push([currentNode.key, currentNode.value]);
            currentNode = currentNode.nextNode;
        }
        return output;
    }
    ...
    insertAt(key, value, index) {
        ...
        let newNode = new Node(key, value, targetNode);
